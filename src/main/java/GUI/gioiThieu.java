...
public class gioiThieu extends javax.swing.JFrame {
    ...
    public gioiThieu() {
        ...
        jTextPane1.setText("Polypro là dự án mẫu mục tiêu chính là huấn luyện sinh viên qui trình thực hiện dự án\n\n"
                + "Mục tiêu của dự án này là để rèn luyện kỹ năng IO (CDIO) tức không yêu cầu sinh viên thu thập phân tích mà chỉ thực hiện và vận hành một phần mềm chuẩn bị cho các dự án sau này. Các kỹ năng cần có CD (trong CDIO) sẽ được huấn ở dự án 1 và dự án 2\n\n"
