...
public class msgBox {
    ...
    public static String prompt(Component parent, String meassage){
        return JOptionPane.showInputDialog(parent, meassage, "Hệ thống quản lý đào tạo", JOptionPane.INFORMATION_MESSAGE);
    }
}
